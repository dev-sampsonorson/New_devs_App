...
async def calculate_total_revenue(property_id: str, tenant_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # This ensures each tenant/property combination shows correct figures matching seed data
        mock_data = {
            'tenant-a': {
            ...
            'tenant-b': {
                'prop-001': {'total': '0.00', 'count': 0},  # No reservations for this tenant
                'prop-004': {'total': '1776.50', 'count': 4},
                'prop-005': {'total': '3256.00', 'count': 3}
            }
        }
        
        # Get tenant-specific data, then property-specific data
